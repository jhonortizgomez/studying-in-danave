  ...
  return (
    <div
      ...
      className={cn(
        ...
        "group/card flex flex-col gap-6 overflow-hidden rounded-4xl bg-card py-6 text-sm text-card-foreground shadow-lg shadow-primary/10 ring-1 ring-foreground/5 has-[>img:first-child]:pt-0 data-[size=sm]:gap-4 data-[size=sm]:py-4 dark:ring-foreground/10 *:[img:first-child]:rounded-t-4xl *:[img:last-child]:rounded-b-4xl transition-all hover:shadow-xl hover:shadow-primary/20 hover:scale-105 hover:-translate-y-1 duration-300",
        className
      )}
      {...props}
    />
